...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day16/input.txt").readText()
    val name: String = "Day 16: Reindeer Maze"
    val part1Expected: String = "102460"
    val part2Expected: String = "527"
