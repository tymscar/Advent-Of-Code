...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day20/input.txt").readText()
    val name: String = "Day 20: Race Condition"
    val part1Expected: String = "1317"
    val part2Expected: String = "982474"
