...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day25/input.txt").readText()
    val name: String = "Day 25: Code Chronicle"
    val part1Expected: String = "3133"
    val part2Expected: String = ""
