...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day12/input.txt").readText()
    val name: String = "Day 12: Garden Groups"
    val part1Expected: String = "1370258"
    val part2Expected: String = "805814"
