...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day07/input.txt").readText()
    val name: String = "Day 07: Bridge Repair"
    val part1Expected: String = "1289579105366"
    val part2Expected: String = "92148721834692"
