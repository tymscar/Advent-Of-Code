...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day10/input.txt").readText()
    val name: String = "Day 10: Hoof It"
    val part1Expected: String = "638"
    val part2Expected: String = "1289"
