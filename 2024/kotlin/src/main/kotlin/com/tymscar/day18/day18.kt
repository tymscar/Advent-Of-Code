...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day18/input.txt").readText()
    val name: String = "Day 18: RAM Run"
    val part1Expected: String = "324"
    val part2Expected: String = "46,23"
