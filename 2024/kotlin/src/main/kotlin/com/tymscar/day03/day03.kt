...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day03/input.txt").readText()
    val name: String = "Day 03: Mull It Over"
    val part1Expected: String = "159833790"
    val part2Expected: String = "89349241"
