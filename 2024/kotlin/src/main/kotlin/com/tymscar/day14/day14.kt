...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day14/input.txt").readText()
    val name: String = "Day 14: Restroom Redoubt"
    val part1Expected: String = "218965032"
    val part2Expected: String = "7037"
