...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day17/input.txt").readText()
    val name: String = "Day 17: Chronospatial Computer"
    val part1Expected: String = "6,0,6,3,0,2,3,1,6"
    val part2Expected: String = "236539226447469"
