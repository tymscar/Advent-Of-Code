...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day19/input.txt").readText()
    val name: String = "Day 19: Linen Layout"
    val part1Expected: String = "213"
    val part2Expected: String = "1016700771200474"
