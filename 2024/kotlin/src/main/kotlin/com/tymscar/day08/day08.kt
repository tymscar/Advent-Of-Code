...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day08/input.txt").readText()
    val name: String = "Day 08: Resonant Collinearity"
    val part1Expected: String = "240"
    val part2Expected: String = "955"
