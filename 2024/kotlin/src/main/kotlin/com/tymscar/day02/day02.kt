...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day02/input.txt").readText()
    val name: String = "Day 02: Red-Nosed Reports"
    val part1Expected: String = "639"
    val part2Expected: String = "674"
