...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day01/input.txt").readText()
    val name: String = "Day 01: Historian Hysteria"
    val part1Expected: String = "1189304"
    val part2Expected: String = "24349736"
