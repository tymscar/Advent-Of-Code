...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day22/input.txt").readText()
    val name: String = "Day 22: Monkey Market"
    val part1Expected: String = "12759339434"
    val part2Expected: String = "1405"
