...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day09/input.txt").readText()
    val name: String = "Day 09: Disk Fragmenter"
    val part1Expected: String = "6310675819476"
    val part2Expected: String = "6335972980679"
