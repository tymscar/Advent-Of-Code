...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day15/input.txt").readText()
    val name: String = "Day 15: Warehouse Woes"
    val part1Expected: String = "1406628"
    val part2Expected: String = "1432781"
