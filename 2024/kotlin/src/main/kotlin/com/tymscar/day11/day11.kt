...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day11/input.txt").readText()
    val name: String = "Day 11: Plutonian Pebbles"
    val part1Expected: String = "212655"
    val part2Expected: String = "253582809724830"
