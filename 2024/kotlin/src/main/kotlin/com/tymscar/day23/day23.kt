...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day23/input.txt").readText()
    val name: String = "Day 23: LAN Party"
    val part1Expected: String = "1108"
    val part2Expected: String = "ab,cp,ep,fj,fl,ij,in,ng,pl,qr,rx,va,vf"
