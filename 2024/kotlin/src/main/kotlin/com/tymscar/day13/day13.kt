...
fun solve(): Solution {
    val input: String = File("src/main/kotlin/com/tymscar/day13/input.txt").readText()
    val name: String = "Day 13: Claw Contraption"
    val part1Expected: String = "28887"
    val part2Expected: String = "96979582619758"
